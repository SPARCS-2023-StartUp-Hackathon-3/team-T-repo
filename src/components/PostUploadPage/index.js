  ...
  const onFormSubmit = async (event) => {
    ...
    if (attachment != "") {
      const attachmentRef = storageService
        .ref()
        .child(`${category}/${dateString}/${"id"}/${uuidv4()}`);
    ...
    <>
      ...
      {isLoggedIn ? (
        <St.UploadContainer>
          ...
          <St.InputContainer>
            <St.InputTitle>제목</St.InputTitle>
            ...
            <St.Inputbox
              ...
              required
            />
            <St.InputTitle>내용</St.InputTitle>
            ...
            <St.InputTitle>Prompt</St.InputTitle>
            ...
            <St.Inputbox
              ...
              required
            />
            <St.InputTitle>Navigate_prompt</St.InputTitle>
